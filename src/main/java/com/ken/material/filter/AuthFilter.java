package com.ken.material.filter;
...
public class AuthFilter extends FormAuthenticationFilter {
    ...
    protected boolean onLoginSuccess(AuthenticationToken token, Subject subject, ServletRequest request, ServletResponse response) {
        SysUser manager = sysUserService.getByUsername(token.getPrincipal() + "");
        subject.getSession().setAttribute(CommonConstant.SYS_SESSION_ATTR_KEY, manager);
        return true;
    }
